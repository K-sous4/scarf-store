export const PURCHASE_TERMS_VERSION = "2026-06-01"

export const PURCHASE_TERMS_TITLE = "Termo de Compra e Garantia de Entrega"

export const PURCHASE_TERMS_SUMMARY =
  "Pagamento vinculado ao pedido, confirmação em duas etapas e registro de entrega pela loja em até 7 dias úteis após o pagamento confirmado."

export const PURCHASE_TERMS_CLAUSES: string[] = [
  ...
  "Em caso de descumprimento, o comprador pode solicitar cancelamento/reembolso conforme o Código de Defesa do Consumidor; este registro digital serve como evidência da transação.",
